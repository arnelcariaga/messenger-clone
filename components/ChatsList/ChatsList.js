...
export default function ChatsList(
  showBottomSheetNewMessage,
  setShowBottomSheetNewMessage
) {
  const [showBottomSheetSearch, setShowBottomSheetSearch] =
  ...
  const renderUsersList = React.useCallback(
    ({ item }) => <UsersList item={item} />,
    []
  );

  const renderUsersListHeader = React.useCallback(
    () => <UsersListHeader />,
    []
  );

  const renderModalSearchUsers = React.useCallback(
    () => <ModalSearchUsers />,
    [showBottomSheetSearch]
  );

  const renderModalNewMessage = React.useCallback(
    () => (
      <ModalNewMessage
        setShowBottomSheetNewMessage={(v) => setShowBottomSheetNewMessage(v)}
        showBottomSheetNewMessage={showBottomSheetNewMessage}
      />
    ),
    [showBottomSheetNewMessage]
  );
